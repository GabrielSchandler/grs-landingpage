    ...
    >
      ...
      <div className="grid gap-3 lg:grid-cols-[1fr_0.86fr_auto]">
        ...
        <button
          ...
          className={cn(
            "inline-flex min-h-12 items-center justify-center gap-2 rounded-md border px-5 py-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-zinc-950 lg:min-w-52",
            canSubmit
